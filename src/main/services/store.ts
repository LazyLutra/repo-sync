...
import { AppConfig, SavedEnvService, Workflow } from '../../../shared/types'
...
export const configStore = {
  ...
  getWorkflow: (): Workflow | undefined => store.get('savedWorkflow'),
  setWorkflow: (workflow: Workflow) => store.set('savedWorkflow', workflow),
}
